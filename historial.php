        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editar_peticion.php?id=<?= $fila['id'] ?>" class="boton editar">Editar</a>
                        <a href="eliminar_peticion.php?id=<?= $fila['id'] ?>" class="boton eliminar" onclick="return confirm('¿Estás seguro de eliminar esta solicitud?')">Borrar</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
...
<script src="js/solicitudapi.js"></script>
</html>
